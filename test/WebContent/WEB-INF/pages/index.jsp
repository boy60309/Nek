...
<head>
<meta charset="UTF-8">
<title>Taidoc POCT</title>

<!-- Bootstrap Core CSS -->
<link href="http://localhost:8080/test/css/bootstrap.min.css" rel="stylesheet">

<!-- MetisMenu CSS -->
<link href="http://localhost:8080/test/css/metisMenu.min.css" rel="stylesheet">

<!-- Timeline CSS -->
<link href="http://localhost:8080/test/css/timeline.css" rel="stylesheet">

<!-- Custom CSS -->
<link href="http://localhost:8080/test/css/startmin.css" rel="stylesheet">

<!-- Morris Charts CSS -->
<link href="http://localhost:8080/test/css/morris.css" rel="stylesheet">

<!-- Custom Fonts -->
<link href="http://localhost:8080/test/css/font-awesome.min.css" rel="stylesheet"
	type="text/css">
</head>
<body>
...
<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.html">Taidoc POCT</a>
			</div>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li>
							...
							<a href="#"><i class="fa fa-table fa-fw"></i> Table<span
								class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="meter_tables.html">儀器總覽<br>(Meter
										list)
								</a></li>
								<li><a href="qc_table.html">品質測試總覽<br>(QC list)
								</a></li>
								<li><a href="op_table.html">操作者總覽<br>(Operator
										list)
								</a></li>
								<li><a href="pat_table.html">病患總覽<br>(Patient
										list)
								</a></li>
								<li><a href="strips_table.html">試片<br>(Strips
										list)
								</a></li>
								<li><a href="division_table.html">部門門診<br>(Division
										list)
								</a></li>
						...
						<li><a href="#"><i class="fa fa-cogs fa-fw"></i> POCT
								Configure <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="SysCfg.html">系統設定<br>(System
										Configure)
								</a></li>
								<li><a href="meter.html">儀器部屬<br>(Meters Deploy)
								</a></li>
								<li><a href="meter_set.html">儀器設定表<br>(Meter
										Configure Table)
								</a></li>
								<li><a href="department.html">部門門診設定<br>(Divisions
										Configure)
								</a></li>
								<li><a href="strips.html">試片設定<br>(Strips
										Configure)
								</a></li>
								<li><a href="user.html">使用者設定<br>(User Configure)
								</a></li>
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge" id="MeterNum">0</div>
										<div>Meters!</div>
									</div>
								</div>
							</div>
						...
						<div class="panel panel-green">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge" id="UnQCNum">0</div>
										<div>QC!</div>
									</div>
								</div>
							</div>
						...
						<div class="panel panel-yellow">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge" id="OpUserNum">0</div>
										<div>Users!</div>
									</div>
						...
						<div class="panel panel-lyellow">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge" id="PatUserNum">0</div>
										<div>Patients!</div>
									</div>
						...
						<div class="panel panel-red">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge" id="StripNum">0</div>
										<div>Strips!</div>
									</div>
								</div>
							</div>
						...
						<div class="panel panel-purple">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge" id="DeptNum">0</div>
										<div>Division!</div>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="panel panel-default">
							<div class="panel-heading">
								<i class="fa fa-area-chart fa-fw"></i> Glucose test frequency
					...
					<div class="col-lg-4">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<!-- /.list-group -->
								<a href="#" class="btn btn-default btn-block" onclick="showdata()">View All
									Alerts</a>
							</div>
							<!-- /.panel-body -->
						</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<i class="fa fa-bar-chart-o fa-fw"></i> Strip available information
							</div>
							<div class="panel-body">
	...
	<script src="http://localhost:8080/test/js/bootstrap.min.js"></script>

	<!-- Metis Menu Plugin JavaScript -->
	<script src="http://localhost:8080/test/js/metisMenu.min.js"></script>

	<!-- Morris Charts JavaScript -->
	
	<script src="http://localhost:8080/test/js/raphael.min.js"></script>
	<script src="http://localhost:8080/test/js/morris.min.js"></script>
	<script src="http://localhost:8080/test/js/morris-data.js"></script>
	 

	<!-- Custom Theme JavaScript -->
	<script src="http://localhost:8080/test/js/startmin.js"></script>
</body>
</html>